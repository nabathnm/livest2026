...
final List<Map<String, dynamic>> dummyLivestockProducts = [
  // --- KATEGORI OBAT SAPI ---
  {
    ...
    "description": "Obat suntik ampuh untuk mengobati cacingan, scabies (kudis), dan kutu pada sapi dan kambing.",
    "price": 65000,
    "type": "obat",
  ...
  },
  {
    ...
    "description": "Antibiotik spektrum luas untuk sapi mencret, infeksi saluran nafas, dan luka. Isi 100 kapsul.",
    "price": 45000,
    "type": "obat",
  ...
  },
  {
    ...
    "description": "Obat suntik antibiotik untuk mengobati mastitis (radang ambing) dan diare parah pada sapi perah.",
    "price": 120000,
    "type": "obat",
  ...
  },
  {
    "id": "prod_004",
    "name": "Colibact Bolus",
    "description": "Obat pil besar (bolus) khusus untuk sapi mencret (diare berdarah/scours) akibat bakteri E. coli.",
    "price": 85000,
    "type": "obat",
    "animals": ["sapi", "pedet"],
  ...
  },
  {
    ...
    "description": "Obat semprot untuk luka luar, mencegah infeksi lalat (belatungan) pada sapi dan kambing.",
    "price": 35000,
    "type": "obat",
    "animals": ["sapi", "kambing", "ayam"],
  ...
  // --- KATEGORI PAKAN & VITAMIN SAPI ---
  {
    ...
    "description": "Pakan konsentrat tinggi protein untuk penggemukan sapi potong. Kemasan karung 50kg.",
    "price": 185000,
    "type": "pakan",
    "animals": ["sapi potong"],
  ...
  },
  {
    ...
    "description": "Vitamin dan mineral jilat (mineral block) untuk menambah nafsu makan sapi dan mencegah kelumpuhan.",
    "price": 25000,
    "type": "vitamin",
  ...
  },
  {
    ...
    "description": "Vitamin suntik untuk memulihkan stamina sapi yang lesu, kurus, atau pasca melahirkan.",
    "price": 55000,
    "type": "vitamin",
    "animals": ["sapi", "kambing", "domba"],
    "location": "Apotek Hewan KUD Karangploso, Malang",
  ...
  // --- KATEGORI OBAT & PAKAN AYAM ---
  {
    ...
    "description": "Obat ampuh untuk ayam ngorok (CRD), snot, berak kapur, dan kolera.",
    "price": 15000,
    "type": "obat",
  ...
  },
  {
    ...
    "description": "Pakan komplit crumble untuk anak ayam (starter) usia 1-21 hari. Kemasan karung 50kg.",
    "price": 380000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Vaksin injeksi untuk pencegahan massal penyakit mematikan ND dan Flu Burung pada ayam petelur.",
    "price": 110000,
    "type": "obat",
  ...
  },
  {
    "id": "prod_012",
    "name": "Vita Chicks",
    "description": "Vitamin serbuk larut air untuk mengurangi stres anak ayam dan mempercepat pertumbuhan.",
    "price": 25000,
    "type": "vitamin",
    "animals": ["ayam", "DOC"],
    "location": "Poultry Shop Arema, Blimbing, Kota Malang",
  ...
  // --- KATEGORI OBAT KAMBING & DOMBA ---
  {
    ...
    "description": "Cairan antasida bentuk drench untuk mengatasi perut kembung (masuk angin parah) pada kambing akibat makan rumput basah.",
    "price": 30000,
    "type": "obat",
  ...
  },
  {
    ...
    "description": "Salep mata untuk mengobati mata belekan (pink eye) merah dan berair pada kambing dan domba.",
    "price": 20000,
    "type": "obat",
  ...
  // --- LAYANAN DOKTER HEWAN / VET (Bisa dipanggil AI juga) ---
  {
    ...
    "description": "Drh. Anton melayani pemeriksaan ternak sakit, inseminasi buatan (IB), dan operasi langsung ke kandang. Wilayah Malang Raya.",
  ...
  },
  {
    ...
    "description": "Pur komplit khusus bebek petelur umur >20 minggu. Sangat bagus untuk meningkatkan kualitas telur.",
    "price": 360000,
    "type": "pakan",
    "animals": ["bebek"],
    "location": "Distributor Pakan Ternak Sidoarjo, Sedati, Sidoarjo, Jawa Timur",
    "phone": "081199887766",
  },
  {
    "id": "prod_018",
    "name": "Layanan Vaksinasi PMK",
    "description": "Tim medis hewan menyediakan layanan pemanggilan untuk vaksinasi Penyakit Mulut dan Kuku (PMK).",
    "price": 150000,
    "type": "jasa",
    "animals": ["sapi", "kambing", "domba"],
  ...
  // --- JAWA BARAT & DKI JAKARTA ---
  {
    ...
    "description": "Antibiotik amoxicillin berspektrum luas, aman untuk ternak bunting.",
    "price": 135000,
    "type": "obat",
    "animals": ["sapi perah", "kuda", "kambing"],
    "location": "Koperasi Peternak Bandung Selatan (KPBS) Pangalengan, Kab. Bandung, Jawa Barat",
    "phone": "081223344556",
  },
  {
    "id": "prod_020",
    "name": "Konsentrat Sapi Perah Super",
    "description": "Pakan konsentrat hijauan fermentasi dengan penambahan molase untuk meningkatkan produksi susu harian hingga 20%.",
    "price": 210000,
    "type": "pakan",
    "animals": ["sapi perah"],
  ...
  },
  {
    ...
    "description": "Antistres paling ampuh untuk ayam pedaging dan bebek di saat cuaca ekstrem (panas).",
    "price": 50000,
    "type": "vitamin",
    "animals": ["ayam", "bebek", "unggas"],
  ...
  },
  {
    ...
    "description": "Melayani operasi caesar sapi, bedah patah tulang cempe, dan konsultasi kesehatan peternakan terintegrasi.",
    "price": 250000,
    "type": "jasa",
  ...
  // --- JAWA TENGAH & DI YOGYAKARTA ---
  {
    ...
    "description": "Cairan desinfektan untuk sterilisasi kandang, alat tetas telur, dan membasmi virus flu burung.",
    "price": 40000,
    "type": "obat",
    "animals": ["semua hewan"],
  ...
  },
  {
    ...
    "description": "Pakan komplit bentuk tepung untuk burung puyuh petelur dewasa. Protein 20%.",
    "price": 340000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Obat kutu tetes punggung, praktis tanpa suntik untuk memberantas ektoparasit dan cacing pada sapi.",
    "price": 115000,
    "type": "obat",
    "animals": ["sapi", "kambing"],
  ...
  },
  {
    ...
    "description": "Vaksin wajib untuk sapi di daerah endemis antraks. Penjualan diawasi oleh Dinas Peternakan.",
    "price": 150000,
    "type": "obat",
    "animals": ["sapi", "kerbau"],
  ...
  },
  {
    ...
    "description": "Pakan khusus pendamping hijauan untuk penggemukan ras sapi bali & limousin silangan.",
    "price": 195000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Pengobatan ternak sapi sakit keras, demam tiga hari (BEF), dan potong kuku sapi perah.",
    "price": 150000,
    "type": "jasa",
  ...
  // --- SULAWESI (MAKASSAR, MANADO) ---
  {
    ...
    "description": "Antibiotik andalan membasmi infeksi Mycoplasma dan saluran kemih pada ternak ruminansia.",
    "price": 85000,
    "type": "obat",
  ...
  },
  {
    ...
    "description": "Pakan pre-starter super untuk anak babi (piglet) lepas sapih agar tidak diare.",
    "price": 280000,
    "type": "pakan",
    "animals": ["babi"],
  ...
  // --- BALI & NUSA TENGGARA ---
  {
    ...
    "description": "Obat khusus untuk koksidiosis (berak darah) parah pada sapi dan cempe.",
    "price": 90000,
    "type": "obat",
    "animals": ["sapi", "kambing"],
  ...
  },
  {
    ...
    "description": "Pakan harian energi tinggi berbentuk pelet dan butiran jagung untuk kuda pacu/kuda tunggang.",
    "price": 450000,
    "type": "pakan",
    "animals": ["kuda"],
  ...
  },
  {
    ...
    "description": "Melayani pengobatan sapi Bali, atensi melahirkan sungsang (distokia), dan vaksin jembrana.",
    "price": 200000,
    "type": "jasa",
  ...
  // --- KALIMANTAN ---
  {
    ...
    "description": "Campuran asam amino esensial dan vitamin cair untuk mempercepat adaptasi DOC yang baru tiba di kandang (mencegah mati stress).",
    "price": 60000,
    "type": "vitamin",
  ...
  },
  {
    ...
    "description": "Jasa pengelolaan limbah kotoran sapi skala besar untuk integrasi sumur biogas komunal perumahan swadaya ternak.",
    "price": 450000,
    "type": "jasa",
    "animals": ["sapi", "kerbau"],
  ...
  // --- WILAYAH JABODETABEK & BANTEN ---
  {
    ...
    "description": "Kandang kelinci pedaging bahan kawat galvanis anti karat. Sistem baterai susun 2 tingkat.",
    "price": 350000,
    "type": "perlengkapan",
    "animals": ["kelinci"],
  ...
  },
  {
    ...
    "description": "Pakan pelet premium impor untuk kuda equestrian, memaksimalkan performa otot dan stamina.",
    "price": 600000,
    "type": "pakan",
    "animals": ["kuda"],
    "location": "Pondok Cabe Stable Supply, Pamulang, Tangerang Selatan, Banten",
    "phone": "081223344002",
  },
  {
    "id": "prod_039",
    "name": "Vitamin E + Selenium (Injeksi)",
    "description": "Meningkatkan fertilitas (kesuburan) induk sapi dan domba, mencegah retensi plasenta.",
    "price": 125000,
    "type": "vitamin",
  ...
  },
  {
    ...
    "description": "Layanan deteksi dini kebuntingan dengan alat USG portabel langsung di kandang peternak.",
    "price": 300000,
    "type": "jasa",
  ...
  // --- WILAYAH JAWA TENGAH & DIY ---
  {
    ...
    "description": "Pakan khusus anak entok (DOE) agar tumbuh cepat dan sehat. Tekstur halus mudah dicerna.",
    "price": 330000,
    "type": "pakan",
    "animals": ["entok", "bebek"],
  ...
  },
  {
    ...
    "description": "Serbuk PK untuk campuran air mandi atau disinfektan kolam bebek/entok mencegah jamur.",
    "price": 10000,
    "type": "obat",
  ...
  },
  {
    ...
    "description": "Kapsul Flukisida ampuh membasmi cacing hati pada sapi dan kerbau yang gembala di rawa.",
    "price": 55000,
    "type": "obat",
    "animals": ["sapi", "kerbau"],
  ...
  },
  {
    ...
    "description": "Incubator full otomatis putar telur untuk ayam, bebek, burung puyuh. Sangat hemat listrik.",
    "price": 850000,
    "type": "perlengkapan",
  ...
  // --- WILAYAH JAWA TIMUR (LUAR MALANG) ---
  {
    ...
    "description": "Antibiotik kerja panjang (tahan 3 hari) untuk infeksi pernafasan berat / Pneumonia sapi.",
    "price": 95000,
    "type": "obat",
    "animals": ["sapi", "kambing", "babi"],
  ...
  },
  {
    ...
    "description": "Pakan pengenalan hijauan untuk pedet agar lambung ganda cepat berkembang sempurna.",
    "price": 175000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Kapur aktif (gamping) untuk ditabur di lantai kandang, membunuh bakteri dan mengurangi bau amonia.",
    "price": 15000,
    "type": "perlengkapan",
    "animals": ["semua hewan"],
  ...
  // --- WILAYAH SUMATERA (ACEH, RIAU, JAMBI) ---
  {
    ...
    "description": "Vaksin wajib mencegah penyakit Ngorok (SE) yang sangat mematikan pada Sapi dan Kerbau.",
    "price": 120000,
    "type": "obat",
    "animals": ["kerbau", "sapi"],
  ...
  },
  {
    ...
    "description": "Bahan pakan alternatif sumber protein & energi tinggi untuk sapi potong di areal perkebunan.",
    "price": 2500, // Harga per kg, biasanya jual ton-an, kita buat per kg untuk simulasi
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Jasa suntik kawin buatan (IB) sperma sapi Brahman Cross ke indukan lokal.",
    "price": 150000,
    "type": "jasa",
    "animals": ["sapi"],
  ...
  },
  {
    ...
    "description": "Serbuk antibiotik campur air minum khusus unggas puyuh mengobati bengkak mata / snot.",
    "price": 25000,
    "type": "obat",
    "animals": ["burung puyuh"],
  ...
  // --- WILAYAH KALIMANTAN (PONTIANAK, PALANGKARAYA) ---
  {
    ...
    "description": "Pakan khusus pembesaran ayam Jowo Super (Joper). Pertumbuhan daging cepat dan padat.",
    "price": 370000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Antibiotik murah meriah untuk infeksi tetanus atau luka parah akibat benda tajam pada ternak babi.",
    "price": 40000,
    "type": "obat",
    "animals": ["babi", "kuda", "sapi"],
    "location": "Apotek Veteriner Palangkaraya, Palangkaraya, Kalimantan Tengah",
    "phone": "081223344017",
  },
  {
    "id": "prod_054",
    "name": "Jasa Konsultan Pembuatan Kandang Close House",
    "description": "Konsultasi sistem ventilasi, blower, cooling pad untuk peternakan ayam broiler skala industri.",
    "price": 1500000,
    "type": "jasa",
  ...
  // --- WILAYAH SULAWESI (PALU, KENDARI, GORONTALO) ---
  {
    ...
    "description": "Suplemen mineral dasar paling murah untuk campuran hijauan pakan sapi agar tidak kekurangan sodium.",
    "price": 5000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Vaksin esensial mencegah wabah Kolera Babi (Classical Swine Fever) yang mematikan dan menular cepat.",
    "price": 200000,
    "type": "obat",
    "animals": ["babi"],
  ...
  },
  {
    ...
    "description": "Cairan manis penambah energi instan dan penambah palatabilitas (aroma) untuk pakan fermentasi ternak ruminansia. Jerigen 5 Liter.",
    "price": 60000,
    "type": "vitamin",
    "animals": ["sapi", "kambing", "domba"],
  ...
  // --- WILAYAH MALUKU & PAPUA ---
  {
    ...
    "description": "Injeksi B12 khusus untuk babi dan ayam mengatasi anemia, lemas, dan merangsang pertumbuhan.",
    "price": 30000,
    "type": "vitamin",
    "animals": ["babi", "ayam"],
  ...
  },
  {
    ...
    "description": "Pengusir lalat dan serangga efektif untuk area pembuangan kotoran kandang babi.",
    "price": 25000,
    "type": "perlengkapan",
    "animals": ["babi", "ayam"],
  ...
  },
  {
    ...
    "description": "Pakan pendamping rumput padang gembala untuk penggemukan sapi bali di wilayah Indonesia Timur.",
    "price": 220000,
    "type": "pakan",
  ...
  },
  {
    ...
    "description": "Pemeriksaan dan pengobatan ternak sapi sakit, potong kuku, dan konsultasi gizi.",
    "price": 200000,
    "type": "jasa",
    "animals": ["sapi", "babi"],
