...
import 'package:livest/features/buyer/home/pages/widgets/buyer_home_skeleton.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<BuyerMarketplaceProvider>(
          builder: (context, provider, _) {
            if (provider.isLoading) {
              return const BuyerHomeSkeleton();
            }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Consumer<BuyerMarketplaceProvider>(
                          builder: (context, providerInner, _) {
                            if (providerInner.products.isEmpty) {
                              return Center(
                                child: Padding(
                            ...
                            return GridView.builder(
                              ...
                              itemCount: providerInner.products.length,
                              gridDelegate:
                              ...
                              itemBuilder: (context, index) {
                                final product = providerInner.products[index];
                                return ProductCard(
                                  product: product,
                                  onTap: () {
                                    Navigator.push(
