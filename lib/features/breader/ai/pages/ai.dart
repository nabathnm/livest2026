        ...
        leading: Padding(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: const Icon(Icons.arrow_back_ios_new_rounded, size: 18, color: LivestColors.textHeading),
            ),
          ),
        ),
        title: const Text(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          ..._suggestedQuestions.map((q) => SuggestedQuestionButton(
                text: q,
                onTap: () {
                  _controller.text = q;
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: LivestColors.baseWhite,
              border: Border.all(color: LivestColors.primaryLightActive, width: 1.5),
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    style: const TextStyle(fontSize: LivestSizes.fontSizeSm, color: LivestColors.textPrimary),
                    decoration: const InputDecoration(
                      hintText: "Apa yang ingin kamu tanyakan?",
                      hintStyle: TextStyle(color: Colors.grey, fontSize: LivestSizes.fontSizeSm),
                ...
                InkWell(
                  onTap: provider.isLoading ? null : () => _sendMessage(provider, _controller.text),
                  child: const Padding(
