...
class _ForgotPasswordOtpPageState extends State<ForgotPasswordOtpPage> {
  ...
  Future<void> _executeUpdatePassword() async {
    ...
    if (ok && mounted) {
      ...
      setState(() => _formError = auth.errorMessage ?? "Gagal mereset password");
      auth.clearError();
    }
  }
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: _step == 0 ? _buildOtpScreen() : _buildNewPasswordScreen(),
              ),
            ),
          ],
        ),
      ...
      child: Column(
        children: [
          ...
          CustomTextFieldPill(
            ...
            prefixIcon: const Icon(Icons.person_outline, color: LivestColors.textSecondary, size: 20),
          ...
          if (_newPasswordController.text.isNotEmpty)
            Padding(
              padding: const EdgeInsets.only(top: LivestSizes.spaceBtwInputFields),
              child: Container(
                width: double.infinity,
