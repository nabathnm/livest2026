...
class _SplashPageState extends State<SplashPage> {
  ...
  Future<void> _checkAuthAndRoute() async {
    ...
    if (session == null) {
      if (mounted) Navigator.pushReplacementNamed(context, RouteGenerator.login);
      return;
    }
    ...
    try {
      ...
      if (profile == null || profile['role'] == null) {
        ...
        Navigator.pushReplacementNamed(context, RouteGenerator.peternakHome);
      } else if (profile['role'] == 'pembeli') {
        // Jika pembeli, lempar ke Dashboard Pembeli
        Navigator.pushReplacementNamed(context, RouteGenerator.pembeliHome);
      } else {
        // Fallback keamanan
