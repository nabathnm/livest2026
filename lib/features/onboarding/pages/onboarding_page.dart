  ...
  Widget _buildProgressBar(double progress) {
    return Container(
      ...
      child: FractionallySizedBox(
        ...
        child: Container(
          decoration: BoxDecoration(color: const Color(0xFF6D4C41), borderRadius: BorderRadius.circular(10)),
        ),
      ),
    );
  }
          ...
          child: PageView(
            ...
            children: [
              ...
              _buildStepLayout(
                ...
                content: Row(
                  children: [
                    Expanded(child: _buildRoleCard('Peternak', Icons.pets, 'peternak')),
                    const SizedBox(width: 16),
                    Expanded(child: _buildRoleCard('Pembeli Ternak', Icons.shopping_cart, 'pembeli')),
                  ],
                ),
                onNext: _nextPage,
              ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isSelected ? const Color(0xFF6D4C41) : Colors.grey[300]!, width: 2),
          borderRadius: BorderRadius.circular(16),
        ),
        child: Column(
          children: [
            Icon(icon, size: 48, color: isSelected ? const Color(0xFF6D4C41) : Colors.grey),
            const SizedBox(height: 16),
            Text(title, style: TextStyle(fontWeight: FontWeight.bold, color: isSelected ? Colors.black : Colors.grey), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
