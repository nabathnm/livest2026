import 'package:livest/data/dummy/dummy_livestock_data.dart';
...
class LocalSearchService {
  ...
  static Future<Map<String, dynamic>> searchProducts(String query) async {
    ...
    if (results.isEmpty) {
      return {
        "status": "SUCCESS",
        "message": "Tidak ada obat, pakan, atau layanan yang cocok dengan kata kunci: $query di wilayah tersebut. Coba kata kunci atau lokasi lain."
      };
    }
